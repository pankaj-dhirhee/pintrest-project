 ...
 image.addEventListener("click", (e)=>{
	   ...
	   let userId = e.target.dataset.userid;
	 	 ...
	 	 if(classContain){
			  ...
			  //show the delete box
			  let bounting_client_of_clicked_three_dot = e.target.getBoundingClientRect();
			  delBox.style.display = "inline-block"
			  delBox.style.left = delBoxbounting_client_of_clicked_three_dot.left 10 + "px";
			  delBox.style.top = delBoxbounting_client_of_clicked_three_dot.top + 10 + "px";
